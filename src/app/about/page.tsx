...
const AboutUs: React.FC = () => {
  return (
    <main className="flex flex-col justify-center items-center p-6 min-h-screen">
      <h1 className="text-7xl font-bold mb-8 text-center animate-bounce">About Us</h1>
      <p className="text-xl mb-4 text-center max-w-3xl">
        Welcome to our Agriculture Blog! We are a passionate team of farmers, researchers, and environmental enthusiasts dedicated to sharing knowledge and best practices for sustainable farming. Our goal is to empower farmers with innovative ideas, practical advice, and insights into the latest agricultural technologies.
      </p>
